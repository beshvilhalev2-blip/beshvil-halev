...
export function HandshakeIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M11 12h2a2 2 0 0 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 14" />
      <path d="m7 18 1.6-1.4a2 2 0 0 1 2.4 0L14 18" />
      <path d="M8 12l-2.5 2.5a2.1 2.1 0 0 0 0 3l1.5 1.5" />
      <path d="M16 12l3-3a2.8 2.8 0 0 1 4 0l1 1" />
      <path d="M18 14l-1.5 1.5a2.1 2.1 0 0 1-3 0L12 14" />
    </svg>
  );
}
