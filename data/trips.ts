...
const rawTrips: Trip[] = [
  ...
  },
  {
    slug: "nchl-dn",
    title: "שמורת תל דן",
    subtitle: "נחל מים קריר, צל טבעי ובריכת שכשוך בלב הגליל העליון",
    heroNote: "ביקרנו כאן עם הילדים - אחד ממסלולי המים האהובים בצפון",
    heroNoteLabel: "המלצה אישית",
    region: "צפון",
    category: "טיול מים",
    ...
    seoTitle: "שמורת תל דן - מסלול מים מוצל למשפחות בגליל | שביל הלב",
    metaDescription:
      "שמורת תל דן בגליל העליון: נחל דן הזורם, בריכת שכשוך, מסלול מוצל ונגיש חלקית לעגלות. מחיר כניסה, חניה, זמן הליכה וטיפים מהשטח.",
    ...
    googleMapsUrl:
      "https://www.google.com/maps/search/?api=1&query=33.248611%2C35.651944",
    highlights: [
      "נחל דן - אחד השופעים בישראל, זורם כל השנה",
      "מסלול מוצל לאורך המים - מושלם לימים חמים",
      "בריכת שכשוך קרירה לילדים בסוף המסלול",
      "מסלול נגיש חלקית - מתאים גם לעגלות",
      "אתרים היסטוריים: שער כנעני, טחנת קמח, מצפור האלה",
      "חניה מוסדרת בשער השמורה",
    ],
    about: [
      "שמורת תל דן היא אחת מהחוויות היפות ביותר בגליל העליון - שמורת טבע מנוהלת על ידי רשות הטבע והגנים, שבה נהר הדן זורם בין עצים ירוקים, גשרי עץ ובריכות מים קרירות.",
      "המים כאן קרים וצלולים כמעט בכל עונות השנה, והמסלולים מוצלים ונעימים - בדיוק מה שצריך ביום חם. זה מקום שמשלב טבע, היסטוריה וחוויית מים אמיתית.",
      "בשמורה שלושה מסלולים מסומנים - אדום, כחול וירוק - שכולם מתחילים מחניון השער. המסלול האדום הוא הקצר ביותר ומגיע לבריכת השכשוך; המסלול הכחול עובר במעיינות דן; והירוק מקיף את האתרים ההיסטוריים בשמורה.",
      "יש גם מסלול מונגש שמגיע עד בריכת השכשוך - דבר נדיר ומעולה למשפחות עם עגלת תינוק או לכיסא גלגלים.",
    ],
    personalStory: [
      "הגענו לשמורת תל דן ביום חם במיוחד, כשכל מה שחיפשנו זה מים וצל.",
      "כבר מהרגע שנכנסנו לשמורה, הקסם התחיל - קול המים, הירוק מסביב והרגשה שאנחנו בתוך ג'ונגל קטן בלב הגליל.",
      "הילדים רצו קדימה לבריכת השכשוך, ואני עצרתי רגע על הגשר לצלם את הזרימה. יש משהו מרגיע מאוד במקום הזה - הוא מאלץ אותך להאט.",
      "שכשכנו במים הקרירים, צחקנו, התרעננו והמשכנו הלאה. בסוף היום כולם חזרו עם נעלי מים רטובות, חיוך ותחושה שעשינו טיול אמיתי.",
      "זה בדיוק סוג המקום שאני אוהבת לשתף - נגיש למשפחות, יפה, ועם הרבה מה לגלות בדרך.",
    ],
    cost: [
      { label: "כניסה", value: "₪31 למבוגר, ₪16 לילד (2025)" },
      { label: "חניה", value: "חניה מוסדרת בשער השמורה" },
      { label: "משך בילוי", value: "1.5-3 שעות" },
    ],
    quickFacts: [
      { label: "עלות כניסה", value: "₪31 מבוגר / ₪16 ילד" },
      { label: "מתאים לילדים", value: "כן, במיוחד" },
      { label: "מים כל השנה", value: "כן - זרימה קבועה" },
      { label: "נגיש לעגלות", value: "חלקית - מסלול מונגש" },
      { label: "מרחק הליכה", value: "1-3 ק\"מ (לפי מסלול)" },
      { label: "זמן ביקור", value: "1.5-3 שעות" },
    ],
    gettingThere: {
      parking:
        "חניה מוסדרת ברחבת השער, ליד מרכז המבקרים. הגישה נוחה ברכב פרטי דרך כביש 99, סמוך לקיבוץ דן.",
      walking:
        "כל המסלולים מתחילים מהחניה. המסלול האדום (בריכת השכשוך) - פחות משעה. המסלול הכחול - כשעה וחצי. המסלול הירוק - כשעתיים-שלוש. המסלול המונגש - כ-2 ק\"מ, כשעתיים (רשות הטבע והגנים).",
      notes: [
        "מומלץ להזמין כרטיסים מראש באתר parks.org.il - במיוחד בסופי שבוע וחגים.",
        "בשער השמורה מקבלים מפת מסלולים - כדאי לבחור מסלול לפני שמתחילים.",
        "טלפון לשאלות: 04-6951579.",
      ],
    },
    closingNote:
      "בואו נשמור על הטבע יפה. קחו איתכם את האשפה, אל תאכלו ליד המים ואל תשחו מחוץ לבריכות המסומנות 💚",
    faq: [
      {
        question: "כמה עולה הכניסה?",
        answer:
          "לפי מחירון רשות הטבע והגנים ל-2025: ₪31 למבוגר ו-₪16 לילד (גילאים 5-18). מנויי מטמון נכנסים ללא תשלום.",
      },
      {
        question: "מתאים לעגלות?",
        answer:
          "חלקית. יש מסלול מונגש שמתחיל בחניה ומגיע עד בריכת השכשוך - מתאים גם לעגלות ולכיסאות גלגלים. שאר המסלולים כוללים מדרגות ושבילים צרים יותר.",
      },
      {
        question: "אפשר להיכנס למים?",
        answer:
          "כן - בריכת השכשוך היא המקום המיועד לשכשוך. המים קרירים כל השנה (כ-14°C), אז כדאי להביא נעלי מים ומגבת.",
      },
      {
        question: "כמה זמן לוקח המסלול?",
        answer:
          "תלוי במסלול: האדום - פחות משעה, הכחול - כשעה וחצי, הירוק - כשעתיים-שלוש. המסלול המונגש - כ-2 ק\"מ, כשעתיים.",
      },
      {
        question: "צריך להזמין מראש?",
        answer:
          "מומלץ מאוד, במיוחד בקיץ ובסופי שבוע. ניתן להזמין כרטיסים באתר parks.org.il.",
      },
    ],
    tips: [
      "להזמין כרטיסים מראש באתר parks.org.il",
      "להגיע מוקדם בבוקר - במיוחד בקיץ ובחגים",
      "להביא נעלי מים, מגבת ובגדים להחלפה לילדים",
      "לבחור מסלול לפי גיל הילדים - האדום מתאים למשפחות עם קטנים",
      "לשלב עם טיולים נוספים באזור - עמק החולה, בניאס או נחל השופט",
    ],
    gallery: [
