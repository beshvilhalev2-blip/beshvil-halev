...
TITLE_ALIASES: dict[str, str] = {
    ...
    "עין חרוד": "עין חרוד - בריכות טבעיות בצבע טורקיז עם נוף שפשוט עוצר את הנשימה",
    "פארק נחל לכיש": "פארק לכיש",
    "מצפה נתן": "מצפה אלון",
    "נחל נקרות יקנעם": "פארק נחל קרת",
    "שמורת טבע בניאס": "שמורת הטבע בניאס",
    "שמורת טבע גמלא": "שמורת הטבע גמלא - הנוף הכי עוצמתי שפגשתי בישראל",
    "גני חוגה": "גני חוגה - יום שלם של מים טבעיים, מנוחה תחת העצים והרבה שלווה",
}
